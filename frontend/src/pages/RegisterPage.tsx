...
/* ----------------------- Zod-Schema -----------------------
   Wir verwenden 0 als "nicht gewählt".
-----------------------------------------------------------*/
const schema = z
  .object({
    ...
    bezirkskammer_id: z.number().int().optional(), // 0 = keine Auswahl
  })
...
export default function RegisterPage() {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      mobilnummer: "",
      geburtstag: "",
      kammer_id: 0, // 0 = nicht gewählt
      bezirkskammer_id: 0, // 0 = nicht gewählt
    },
    mode: "onChange",
    criteriaMode: "all",
  });
  ...
  /* ------ Bezirkskammern nachladen, wenn Kammer gewählt ------ */
  useEffect(() => {
  ...
  async function onSubmit(values: FormValues) {
    // Sicherheitsprüfung für Bezirkskammer (falls vorhanden)
    ...
    try {
      await registerUser({
        email: values.email.trim(), // hier trimmen (kein Cursor-Jump im Input)
        password: values.password,
        vorname: values.vorname.trim(),
        nachname: values.nachname.trim(),
        mobilnummer:
          values.mobilnummer && values.mobilnummer.trim() !== ""
            ? values.mobilnummer.trim()
            : null,
        geburtstag:
          values.geburtstag && values.geburtstag.trim() !== ""
            ? values.geburtstag.trim()
            : null,
        kammer_id: values.kammer_id, // garantiert > 0 durch Schema + UI
        bezirkskammer_id:
      ...
      toast.success(
        "Konto erstellt. Dein Account wird nach Freigabe nutzbar. Bitte später anmelden."
      );
      navigate("/login", {
        replace: true,
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Wähle deine zuständige IHK-Kammer.
                  </FormDescription>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <select
                        ...
                        aria-describedby={
                          hasErr("bezirkskammer_id") ? ariaErrId("bezirkskammer_id") : undefined
                        }
                        required
                      >
                        <option value={0}>Bitte wählen…</option>
                    ...
                    <FormDescription>
                      Falls deine Kammer Bezirkskammern hat, bitte hier auswählen.
                    </FormDescription>
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      ...
                      autoComplete="email"
                      {...field}
                      // keine Live-Trim-Logik → Trim erst im Submit
                      aria-invalid={hasErr("email")}
                      aria-describedby={hasErr("email") ? ariaErrId("email") : undefined}
                    />
                  </FormControl>
                  <FormDescription>
                    Wir senden dir Informationen zu deiner Registrierung an diese Adresse.
                  </FormDescription>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Sichere Kombination aus Buchstaben, Zahlen und Sonderzeichen empfohlen.
                  </FormDescription>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Für kurzfristige Rückfragen zu Prüfungsterminen.</FormDescription>
            ...
            <Button
              ...
              disabled={
                ...
                (hasBezirke &&
                  (!form.watch("bezirkskammer_id") ||
                    form.watch("bezirkskammer_id")! <= 0))
              }
            >
